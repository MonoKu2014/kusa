...
<div id="main-content">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden-lg hidden-md" id="content-button-menu-toggle">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 jumbotron">
			...
			<form id="add-user" method="post" action="<?= base_url();?>gastos/guarda_gasto">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<select name="sucursal" class="form-control" required>
		                ...
		                <?php foreach ($this->functions->sucursales() as $c) { ?>
							<option value="<?= $c->id_sucursal;?>"><?= $c->nombre_sucursal;?></option>
						<?php } ?>
					</select>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<select name="tipo" class="form-control" required>
		                ...
		                <?php foreach ($this->functions->tipos_gastos() as $c) { ?>
							<option value="<?= $c->id_tipo_gasto;?>"><?= $c->tipo_gasto;?></option>
						<?php } ?>
					</select>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<textarea name="observacion" id="obs" cols="30" rows="10" class="form-control"></textarea>
				</div>
