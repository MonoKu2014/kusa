...
<div class="modal-body">
    ...
    <div class="col-md-3 <?= ($pedido->estado_pedido == 2) ? 'box-active' : ''; ?>">
        ...
        <p class="text-center <?= ($pedido->estado_pedido == 2) ? 'green' : 'gray'; ?>">Preparando productos</p>
    ...
    <div class="col-md-3 <?= ($pedido->estado_pedido == 3) ? 'box-active' : ''; ?>">
        ...
        <p class="text-center <?= ($pedido->estado_pedido == 3) ? 'green' : 'gray'; ?>">Productos Despachados</p>
    ...
    <div class="col-md-3 <?= ($pedido->estado_pedido == 4) ? 'box-active' : ''; ?>">
        ...
        <p class="text-center <?= ($pedido->estado_pedido == 4) ? 'green' : 'gray'; ?>">Productos Entregados</p>
