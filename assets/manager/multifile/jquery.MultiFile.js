	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			...
			denied: 'No puedes seleccionar un $ext file.\nIntenta otra vez...',
			file: '$file',
			selected: 'Archivo seleccionado: $file',
			duplicate: 'El archivo ha sido seleccionado:\n$file',
			toomuch: 'Los archivos seleccionados exceden el máximo permitido ($size)',
			toomany: 'Demasiados archivos seleccionados (max: $max)',
			toobig: '$file es demasiado pesado (max $size)'
		},
